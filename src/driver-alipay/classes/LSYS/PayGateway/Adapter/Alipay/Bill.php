...
class Bill implements \LSYS\PayGateway\Bill\BillAdapter,\LSYS\PayGateway\Bill\Data{
	/**
	 * @var Config
	 */
	protected $_config;
	...
	public function setDate($date){
		...
		$this->setStartTime(strtotime("today",$time));
		$this->setEndTime(strtotime("today",$time+3600*24));
		return $this;
	}
	public function exec(){
		require_once (__DIR__."/../../../../../libs/alipay_account_page_query/lib/alipay_submit.class.php");
	...
	* 	3012 收费 
 	...
 	* 	6001 在线支付 
	 * @param array $codes
	 * @return \LSYS\PayGateway\Adapter\Alipay\Bill
	 */
	public function setTransCode(array $codes){
		$this->_codes=$codes;
		return $this;
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \LSYS\PayGateway\Bill\Data::getResult()
	 */
